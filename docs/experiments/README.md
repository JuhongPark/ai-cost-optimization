...
- `benchmark-blueprint.md`: initial benchmark design for AI cost optimization studies
- `benchmark-selection-rationale.md`: rationale for why the current benchmark families fit the thesis
