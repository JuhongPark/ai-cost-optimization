...
The SDM-specific material is useful, but it does not replace the broader MIT literature already captured in [mit-research-landscape.md](/home/jpark/Project/ai-cost-optimization/docs/references/mit-research-landscape.md). The best reading is:
